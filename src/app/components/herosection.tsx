...
export default function HeroSection() {
  return (
    ...
    >
      ...
      >
        <p className="inline-block border-2 border-[#1A004A] text-[#1A004A] px-5 py-1 rounded-full text-sm font-medium mt-10 mb-2">
          Hello!
        </p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-10 items-center w-full max-w-7xl relative z-10">
        ...
        >
          ...
          <div className="relative w-[320px] h-[320px] md:w-[420px] md:h-[420px] bg-[#1A004A] rounded-full overflow-hidden translate-y-14 md:translate-y-20 shadow-lg shadow-[#1A004A]/30" />

          {/* Portrait Image (Balanced & Tucked) */}
          <div className="absolute bottom-[-60px] md:bottom-[-110px] z-10">
            <Image
              src="/jerryherosection.png"
              alt="Jeremiah portrait"
              width={450}
              height={650}
              className="object-cover md:w-[400px] md:h-[600px] w-[300px] h-[450px] rounded-full"
            />
          </div>
        </motion.div>
